...
| `sched_escape_ring` | ✓ |   | `count` | Deterministic scheduler snapshot: current/return TCB, PC=0 provenance, active escape, and the last structured scheduler transitions |
