...
/* Bulk ARGB8888 fill of the active display rect into out[y * stride_px + x].
 * Equivalent to nested gpu_display_pixel_argb but far cheaper for FMV (24-bit
 * packed scanout) and large presents. out must hold height * stride_px pixels. */
