...
The recompiler ingests the game's main executable (e.g. SLUS_010.11) as a
...
Usage:
    python tools/extract_psx_exe.py "Front Mission 3 (USA).bin" SLUS_010.11 fm3/SLUS_010.11
